...
@associate_symbols(SymEnum.S_LDATA32_ST, SymEnum.S_LDATA32,
                   SymEnum.S_GDATA32_ST, SymEnum.S_GDATA32,
                   SymEnum.S_LTHREAD32_ST, SymEnum.S_LTHREAD32,
                   SymEnum.S_GTHREAD32_ST, SymEnum.S_GTHREAD32)
@structify
