...
# https://github.com/microsoft/microsoft-pdb/blob/1d60e041600117a5004de84baa960d2c953a6aa6/include/cvinfo.h#L2735
class SymEnum(IntEnum):
    ...
    S_RECTYPE_MAX = auto()               # one greater than last
    #S_RECTYPE_LAST  = auto() - 2 #S_RECTYPE_MAX - 1
    #S_RECTYPE_PAD   = auto() - 2 + 0x100 # S_RECTYPE_MAX + 0x100 # Used *only* to verify symbol record types so that current PDB code can potentially read
